...
public class Reg_User {
    ...
    public static void reg(){
        ...
        System.out.println("Enter a strong password consisting of letters, symbols, and at least one digit, one lowercase, one uppercase letter, and one special character (!@#&()-[]{}:;',?/*~$^+=<>):\t");
        pass=input.next();
        while(!validation.PassVerification(pass)) {
            System.out.println("Enter a strong password consisting of letters, symbols, and at least one digit, one lowercase, one uppercase letter, and one special character (!@#&()-[]{}:;',?/*~$^+=<>):\t");
            pass=input.next();
        ...
        try {
            ...
            System.out.println("Some error occurred while registration");
            e.printStackTrace();
        }
    }
    public static boolean Login(){
